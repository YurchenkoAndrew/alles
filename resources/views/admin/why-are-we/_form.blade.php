...
<div class="row">
    <div class="col-md">
        <div class="form-group">
            <label for="imageService1Old">Текущее изображение</label>
            <img style="width: 200px; height: 200px" src="{{asset($whyAreWe->image_service_1)}}" alt="{{$whyAreWe->title_service_1}}" id="imageService1Old">
            <hr>
            <label for="imageService1">Выбрать изображение</label>
            <input type="file" class="form-control-file" id="imageService1" name="image_service_1">
        </div>
        <div class="form-group">
            <label for="inputTitleService1">Заголовок</label>
            <input type="text" class="form-control" id="inputTitleService1" name="title_service_1"
                   value="{{$whyAreWe->title_service_1}}" required>
        </div>
        <div class="form-group">
            <label for="inputDescriptionService1">Описание</label>
    ...
    <div class="col-md">
        <div class="form-group">
            <label for="imageService2Old">Текущее изображение</label>
            <img style="width: 200px; height: 200px" src="{{asset($whyAreWe->image_service_2)}}" alt="{{$whyAreWe->title_service_2}}" id="imageService2Old">
            <hr>
            <label for="imageService2">Выбрать изображение</label>
            <input type="file" class="form-control-file" id="imageService2" name="image_service_2">
        </div>
        <div class="form-group">
            <label for="inputTitleService2">Заголовок</label>
            <input type="text" class="form-control" id="inputTitleService2" name="title_service_2"
                   value="{{$whyAreWe->title_service_2}}" required>
        </div>
        <div class="form-group">
            <label for="inputDescriptionService2">Описание</label>
    ...
    <div class="col-md">
        <div class="form-group">
            <label for="imageService3Old">Текущее изображение</label>
            <img style="width: 200px; height: 200px" src="{{asset($whyAreWe->image_service_3)}}" alt="{{$whyAreWe->title_service_3}}" id="imageService3Old">
            <hr>
            <label for="imageService3">Выбрать изображение</label>
            <input type="file" class="form-control-file" id="imageService3" name="image_service_3">
        </div>
        <div class="form-group">
            <label for="inputTitleService3">Заголовок</label>
            <input type="text" class="form-control" id="inputTitleService3" name="title_service_3"
                   value="{{$whyAreWe->title_service_3}}" required>
        </div>
        <div class="form-group">
            <label for="inputDescriptionService3">Описание</label>
